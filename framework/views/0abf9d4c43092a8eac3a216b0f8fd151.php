<?php $__env->startSection('title', 'Doctors - MediNest Bootstrap Template'); ?>
<?php $__env->startSection('body-class', 'doctors-page'); ?>
          ...
          <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
            ...
            <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
              ...
              <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-cardiology">
                <article class="doctor-card h-100">
                  <figure class="doctor-media">
                    <img src="<?php echo e(asset('assets/img/health/staff-3.webp')); ?>" class="img-fluid" alt="Dr. Amelia Brooks" loading="lazy">
              ...
              <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-pediatrics">
                <article class="doctor-card h-100">
                  <figure class="doctor-media">
                    <img src="<?php echo e(asset('assets/img/health/staff-7.webp')); ?>" class="img-fluid" alt="Dr. Noah Turner" loading="lazy">
                  </figure>
                  <div class="doctor-content">
              ...
              <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-dermatology">
                <article class="doctor-card h-100">
                  <figure class="doctor-media">
                    <img src="<?php echo e(asset('assets/img/health/staff-12.webp')); ?>" class="img-fluid" alt="Dr. Sofia Bennett" loading="lazy">
              ...
              <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-orthopedics">
                <article class="doctor-card h-100">
                  <figure class="doctor-media">
                    <img src="<?php echo e(asset('assets/img/health/staff-5.webp')); ?>" class="img-fluid" alt="Dr. Ethan Cole" loading="lazy">
                  </figure>
                  <div class="doctor-content">
              ...
              <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-cardiology">
                <article class="doctor-card h-100">
                  <figure class="doctor-media">
                    <img src="<?php echo e(asset('assets/img/health/staff-10.webp')); ?>" class="img-fluid" alt="Dr. Maya Patel" loading="lazy">
                  </figure>
                  <div class="doctor-content">
              ...
              <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-pediatrics">
                <article class="doctor-card h-100">
                  <figure class="doctor-media">
                    <img src="<?php echo e(asset('assets/img/health/staff-2.webp')); ?>" class="img-fluid" alt="Dr. Oliver Hayes" loading="lazy">
                  </figure>
                  <div class="doctor-content">
              ...
              <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-dermatology">
                <article class="doctor-card h-100">
                  <figure class="doctor-media">
                    <img src="<?php echo e(asset('assets/img/health/staff-9.webp')); ?>" class="img-fluid" alt="Dr. Harper Lane" loading="lazy">
                  </figure>
                  <div class="doctor-content">
              ...
              <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-orthopedics">
                <article class="doctor-card h-100">
                  <figure class="doctor-media">
                    <img src="<?php echo e(asset('assets/img/health/staff-6.webp')); ?>" class="img-fluid" alt="Dr. Liam Carter" loading="lazy">
                  </figure>
                  <div class="doctor-content">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL I7\Documents\laravel-implementation\resources\views/doctors.blade.php ENDPATH**/ ?>
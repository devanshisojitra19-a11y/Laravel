<?php $__env->startSection('title', 'Index - MediNest Bootstrap Template'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="row align-items-center">
          <div class="col-lg-5">
            <div class="hero-image" data-aos="fade-right" data-aos-delay="100">
              <img src="<?php echo e(asset('assets/img/health/staff-8.webp')); ?>" alt="Healthcare Professional" class="img-fluid main-image">
          ...
          <div class="col-lg-7" data-aos="fade-right" data-aos-delay="200">
            <div class="image-grid">
              <div class="primary-image">
                <img src="<?php echo e(asset('assets/img/health/facilities-6.webp')); ?>" alt="Modern hospital facility" class="img-fluid">
              ...
              <div class="secondary-images">
                <div class="small-image">
                  <img src="<?php echo e(asset('assets/img/health/consultation-3.webp')); ?>" alt="Doctor consultation" class="img-fluid">
                </div>
                <div class="small-image">
                  <img src="<?php echo e(asset('assets/img/health/surgery-2.webp')); ?>" alt="Medical procedure" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-5" data-aos="fade-left" data-aos-delay="300">
            <div class="content-wrapper">
              ...
              <div class="action-buttons">
                <a href="<?php echo e(route('about')); ?>" class="btn-explore">Explore Our Services</a>
        ...
        <div class="departments-showcase">
              ...
              <div class="col-lg-6 order-lg-2">
                <div class="department-visual">
                  <div class="image-wrapper">
                    <img src="<?php echo e(asset('assets/img/health/emergency-3.webp')); ?>" alt="Emergency Department" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="department-card">
                  ...
                  <div class="card-content">
                    ...
                    <p class="card-description">Cardiology is the medical study of the heart and blood vessels</p>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="350">
                <div class="department-card">
                  ...
                  <div class="card-content">
                    ...
                    <p class="card-description">Neurology is the branch of medicine that deals with the brain, spinal cord, and nervous system.</p>
                    <div class="card-stats">
                      <div class="stat-item">
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="department-card">
                  ...
                  <div class="card-content">
                    ...
                    <p class="card-description">Surgery involves medical procedures performed to treat diseases, injuries, or deformities by operative methods.</p>
                    <div class="card-stats">
                      <div class="stat-item">
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="450">
                <div class="department-card">
                  ...
                  <div class="card-content">
                    ...
                    <p class="card-description">Pediatrics is the branch of medicine focused on the health and medical care of infants, children, and adolescents.</p>
                    <div class="card-stats">
                      <div class="stat-item">
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="department-card">
                  ...
                  <div class="card-content">
                    ...
                    <p class="card-description">Ophthalmology is the branch of medicine that deals with eye care and vision health.</p>
                    <div class="card-stats">
                      <div class="stat-item">
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="550">
                <div class="department-card">
                  ...
                  <div class="card-content">
                    ...
                    <p class="card-description">Dermatology is the branch of medicine that focuses on skin, hair, and nail conditions</p>
                    <div class="card-stats">
                      <div class="stat-item">
          ...
          <div class="departments-cta" data-aos="fade-up" data-aos-delay="600">
            <div class="cta-content">
              ...
              <p class="cta-description">Psychiatry is the branch of medicine that deals with mental health and emotional disorders.</p>
    ...
    <section id="featured-services" class="featured-services section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>Orthopedics is the branch of medicine that treats bones, joints, muscles, and movement-related conditions.</p>
      </div><!-- End Section Title -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-card">
              ...
              <div class="service-image">
                <img src="<?php echo e(asset('assets/img/health/cardiology-2.webp')); ?>" alt="Service" class="img-fluid" loading="lazy">
              </div>
              <div class="service-content">
                <h3>Cardiology Excellence</h3>
                <p>Cardiology Excellence focuses on providing advanced heart care and superior cardiovascular treatment.</p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-card">
              ...
              <div class="service-image">
                <img src="<?php echo e(asset('assets/img/health/neurology-3.webp')); ?>" alt="Service" class="img-fluid" loading="lazy">
              </div>
              <div class="service-content">
                <h3>Neurology Care</h3>
                <p> Neurology Care provides expert diagnosis and treatment of brain and nervous system disorders.</p>
                <a href="#" class="service-link">Learn More <i class="fas fa-arrow-right"></i></a>
              </div>
            </div>
          </div><!-- End Service Card -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-card">
              ...
              <div class="service-image">
                <img src="<?php echo e(asset('assets/img/health/orthopedics-1.webp')); ?>" alt="Service" class="img-fluid" loading="lazy">
              </div>
              <div class="service-content">
                <h3>Orthopedic Surgery</h3>
                <p>Providing safe, reliable, and patient-focused care with a commitment to quality, comfort, and professional excellence.</p>
                <a href="#" class="service-link">Learn More <i class="fas fa-arrow-right"></i></a>
              </div>
            </div>
          </div><!-- End Service Card -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-card">
              ...
              <div class="service-image">
                <img src="<?php echo e(asset('assets/img/health/pediatrics-4.webp')); ?>" alt="Service" class="img-fluid" loading="lazy">
              </div>
              <div class="service-content">
                <h3>Pediatric Care</h3>
                <p>Pediatric Care focuses on comprehensive medical care for infants, children, and adolescents.</p>
                <a href="#" class="service-link">Learn More <i class="fas fa-arrow-right"></i></a>
              </div>
            </div>
          </div><!-- End Service Card -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-card">
              ...
              <div class="service-image">
                <img src="<?php echo e(asset('assets/img/health/oncology-2.webp')); ?>" alt="Service" class="img-fluid" loading="lazy">
              </div>
              <div class="service-content">
                <h3>Oncology Treatment</h3>
                <p>Delivering compassionate, ethical, and patient-centered care while maintaining the highest standards of medical excellence</p>
                <a href="#" class="service-link">Learn More <i class="fas fa-arrow-right"></i></a>
              </div>
            </div>
          </div><!-- End Service Card -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-card">
              ...
              <div class="service-image">
                <img src="<?php echo e(asset('assets/img/health/laboratory-3.webp')); ?>" alt="Service" class="img-fluid" loading="lazy">
              </div>
              <div class="service-content">
                <h3>Laboratory Services</h3>
                <p>Ensuring responsive, reliable, and high-quality healthcare tailored to patient needs and well-being</p>
                <a href="#" class="service-link">Learn More <i class="fas fa-arrow-right"></i></a>
              </div>
            </div>
          </div><!-- End Service Card -->
    ...
    <section id="find-a-doctor" class="find-a-doctor section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Find A Doctor</h2>
        <p>Providing specialized care to address essential medical needs effectively and safely.</p>
      </div><!-- End Section Title -->
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="specialists-showcase" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="specialist-card <?php echo e($loop->first ? 'featured' : ''); ?>" data-aos="slide-up" data-aos-delay="<?php echo e(100 * $loop->iteration); ?>">
            <div class="card-content">
              <div class="specialist-info">
                <div class="profile-section">
                  <div class="profile-image">
                    <img src="<?php echo e(asset($doctor->image)); ?>" alt="<?php echo e($doctor->name); ?>" class="img-fluid">
                    <div class="online-status <?php echo e($doctor->status); ?>"></div>
                  </div>
                  <div class="specialist-data">
                    <h3><?php echo e($doctor->name); ?></h3>
                    <p class="specialty"><?php echo e($doctor->specialty); ?></p>
                    <div class="credentials">
                      <span class="badge"><?php echo e($doctor->credentials); ?></span>
                      <span class="experience"><?php echo e($doctor->experience); ?></span>
                    </div>
                  </div>
                </div>
                <div class="rating-info">
                  <div class="stars-display">
                    <?php for($i = 1; $i <= 5; $i++): ?>
                      ...
                      <?php elseif($i == ceil($doctor->rating) && $doctor->rating != floor($doctor->rating)): ?>
                  ...
                  <span class="score"><?php echo e(number_format($doctor->rating, 1)); ?></span>
                  <small>(<?php echo e($doctor->patients_count); ?> patients)</small>
                </div>
              </div>
              <div class="quick-actions">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="content-wrapper">
                ...
                <div class="action-buttons">
                  <a href="<?php echo e(route('appointment')); ?>" class="primary-btn">Schedule Consultation</a>
                  <a href="<?php echo e(route('services')); ?>" class="secondary-link">
            ...
            <div class="col-lg-6">
              <div class="hero-image" data-aos="zoom-in" data-aos-delay="300">
                <img src="<?php echo e(asset('assets/img/health/showcase-2.webp')); ?>" alt="Healthcare Excellence" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="contact-banner" data-aos="zoom-in" data-aos-delay="600">
          <div class="banner-content">
            ...
            <div class="contact-actions">
              ...
              <a href="<?php echo e(route('contact')); ?>" class="contact-link">Get Directions</a>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/laravel-implementation/resources/views/home.blade.php ENDPATH**/ ?>
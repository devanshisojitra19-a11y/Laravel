<?php $__env->startSection('title', 'Contact - MediNest Bootstrap Template'); ?>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 mt-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <form action="<?php echo e(route('contact.submit')); ?>" method="post" class="php-email-form">
              <?php echo csrf_field(); ?>
              <div class="row gy-3">
                <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL I7\Documents\laravel-implementation\resources\views/contact.blade.php ENDPATH**/ ?>
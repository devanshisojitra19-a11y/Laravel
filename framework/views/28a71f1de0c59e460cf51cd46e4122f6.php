...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'MediNest Bootstrap Template'); ?></title>
    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="<?php echo e(route('departments')); ?>" class="<?php echo e(request()->routeIs('departments*') ? 'active' : ''); ?>">Departments</a></li>
          <li><a href="<?php echo e(route('services')); ?>" class="<?php echo e(request()->routeIs('services*') ? 'active' : ''); ?>">Services</a></li>
          <li><a href="<?php echo e(route('doctors')); ?>" class="<?php echo e(request()->routeIs('doctors') ? 'active' : ''); ?>">Doctors</a></li>
          <li class="dropdown"><a href="#"><span>More Pages</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="<?php echo e(route('department-details')); ?>">Department Details</a></li>
              <li><a href="<?php echo e(route('service-details')); ?>">Service Details</a></li>
              <li><a href="<?php echo e(route('appointment')); ?>">Appointment</a></li>
              <li><a href="<?php echo e(route('testimonials')); ?>">Testimonials</a></li>
              <li><a href="<?php echo e(route('faq')); ?>">Frequently Asked Questions</a></li>
      ...
      <div class="header-buttons d-none d-md-flex align-items-center">
          <a class="btn-getstarted me-2" style="background: transparent; color: var(--accent-color); border: 1px solid var(--accent-color);" href="<?php echo e(route('login')); ?>">Login</a>
        <a class="btn-getstarted" href="<?php echo e(route('appointment')); ?>">Appointment</a>
      </div>
...
</html><?php /**PATH /var/www/laravel-implementation/resources/views/layouts/app.blade.php ENDPATH**/ ?>
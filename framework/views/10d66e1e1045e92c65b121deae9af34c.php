              ...
              <div class="specialist-info">
                <div class="profile-section">
                  <div class="profile-image">
                    <img src="<?php echo e(asset('assets/img/health/staff-1.webp')); ?>" alt="Dr. Jennifer Morgan" class="img-fluid">
          ...
          <div class="specialist-card" data-aos="slide-up" data-aos-delay="200">
            <div class="card-content">
              <div class="specialist-info">
                <div class="profile-section">
                  <div class="profile-image">
                    <img src="<?php echo e(asset('assets/img/health/staff-3.webp')); ?>" alt="Dr. Robert Kim" class="img-fluid">
          ...
          <div class="specialist-card" data-aos="slide-up" data-aos-delay="300">
            <div class="card-content">
              <div class="specialist-info">
                <div class="profile-section">
                  <div class="profile-image">
                    <img src="<?php echo e(asset('assets/img/health/staff-5.webp')); ?>" alt="Dr. Sarah Thompson" class="img-fluid">
                    <div class="online-status active"></div>
                  </div>
                  <div class="specialist-data">
          ...
          <div class="specialist-card" data-aos="slide-up" data-aos-delay="400">
            <div class="card-content">
              <div class="specialist-info">
                <div class="profile-section">
                  <div class="profile-image">
                    <img src="<?php echo e(asset('assets/img/health/staff-7.webp')); ?>" alt="Dr. Michael Rivera" class="img-fluid">
          ...
          <div class="specialist-card" data-aos="slide-up" data-aos-delay="500">
            <div class="card-content">
              <div class="specialist-info">
                <div class="profile-section">
                  <div class="profile-image">
                    <img src="<?php echo e(asset('assets/img/health/staff-9.webp')); ?>" alt="Dr. Lisa Garcia" class="img-fluid">
                    <div class="online-status active"></div>
                  </div>
                  <div class="specialist-data">
          ...
          <div class="specialist-card" data-aos="slide-up" data-aos-delay="600">
            <div class="card-content">
              <div class="specialist-info">
                <div class="profile-section">
                  <div class="profile-image">
                    <img src="<?php echo e(asset('assets/img/health/staff-12.webp')); ?>" alt="Dr. Daniel Wong" class="img-fluid">
                    <div class="online-status active"></div>
                  </div>
                  <div class="specialist-data">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/MediNest/laravel-implementation/resources/views/home.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'About - MediNest Bootstrap Template'); ?>
            ...
            <div class="col-lg-7" data-aos="fade-right" data-aos-delay="200">
              <div class="image-gallery">
                <div class="main-image-container">
                  <img src="<?php echo e(asset('assets/img/health/facilities-3.webp')); ?>" class="img-fluid main-image" alt="Medical facility">
                </div>
                <div class="secondary-images">
                  <img src="<?php echo e(asset('assets/img/health/staff-12.webp')); ?>" class="img-fluid secondary-image" alt="Medical team" data-aos="zoom-in" data-aos-delay="400">
                  <img src="<?php echo e(asset('assets/img/health/consultation-4.webp')); ?>" class="img-fluid secondary-image" alt="Patient consultation" data-aos="zoom-in" data-aos-delay="500">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-8">
              <div class="accreditation-grid">
                <div class="accreditation-item" data-aos="fade-up" data-aos-delay="100">
                  <img src="<?php echo e(asset('assets/img/clients/clients-6.webp')); ?>" class="img-fluid" alt="Healthcare accreditation">
                </div>
                <div class="accreditation-item" data-aos="fade-up" data-aos-delay="150">
                  <img src="<?php echo e(asset('assets/img/clients/clients-7.webp')); ?>" class="img-fluid" alt="Medical certification">
                </div>
                <div class="accreditation-item" data-aos="fade-up" data-aos-delay="200">
                  <img src="<?php echo e(asset('assets/img/clients/clients-8.webp')); ?>" class="img-fluid" alt="Quality assurance">
                </div>
                <div class="accreditation-item" data-aos="fade-up" data-aos-delay="250">
                  <img src="<?php echo e(asset('assets/img/clients/clients-9.webp')); ?>" class="img-fluid" alt="Healthcare excellence">
                </div>
                <div class="accreditation-item" data-aos="fade-up" data-aos-delay="300">
                  <img src="<?php echo e(asset('assets/img/clients/clients-10.webp')); ?>" class="img-fluid" alt="Medical standards">
                </div>
                <div class="accreditation-item" data-aos="fade-up" data-aos-delay="350">
                  <img src="<?php echo e(asset('assets/img/clients/clients-11.webp')); ?>" class="img-fluid" alt="Healthcare certification">
                </div>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL I7\Documents\laravel-implementation\resources\views/about.blade.php ENDPATH**/ ?>
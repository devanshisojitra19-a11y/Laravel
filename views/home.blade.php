...
@section('title', 'Index - MediNest Bootstrap Template')
          ...
          <div class="col-lg-5" data-aos="fade-left" data-aos-delay="300">
            <div class="content-wrapper">
              ...
              <div class="action-buttons">
                <a href="{{ route('about') }}" class="btn-explore">Explore Our Services</a>
    ...
    <section id="find-a-doctor" class="find-a-doctor section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="specialists-showcase" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="specialist-card {{ $loop->first ? 'featured' : '' }}" data-aos="slide-up" data-aos-delay="{{ 100 * $loop->iteration }}">
            <div class="card-content">
              <div class="specialist-info">
                <div class="profile-section">
                  <div class="profile-image">
                    <img src="{{ asset($doctor->image) }}" alt="{{ $doctor->name }}" class="img-fluid">
                    <div class="online-status {{ $doctor->status }}"></div>
                  </div>
                  <div class="specialist-data">
                    <h3>{{ $doctor->name }}</h3>
                    <p class="specialty">{{ $doctor->specialty }}</p>
                    <div class="credentials">
                      <span class="badge">{{ $doctor->credentials }}</span>
                ...
                <div class="rating-info">
                  ...
                  <span class="score">{{ number_format($doctor->rating, 1) }}</span>
                  <small>({{ $doctor->patients_count }} patients)</small>
                </div>
              </div>
              <div class="quick-actions">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="content-wrapper">
                ...
                <div class="action-buttons">
                  <a href="{{ route('appointment') }}" class="primary-btn">Schedule Consultation</a>
                  <a href="{{ route('services') }}" class="secondary-link">
        ...
        <div class="contact-banner" data-aos="zoom-in" data-aos-delay="600">
          <div class="banner-content">
            ...
            <div class="contact-actions">
              ...
              <a href="{{ route('contact') }}" class="contact-link">Get Directions</a>
            </div>
          </div>
        </div>

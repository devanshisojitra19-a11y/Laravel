...
<head>
  ...
  <title>@yield('title', 'MediNest Bootstrap Template')</title>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <div class="header-buttons d-none d-md-flex align-items-center">
          <a class="btn-getstarted me-2" style="background: transparent; color: var(--accent-color); border: 1px solid var(--accent-color);" href="{{ route('login') }}">Login</a>

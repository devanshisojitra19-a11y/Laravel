...
@section('title', 'Departments - MediNest Bootstrap Template')
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="department-item">
              ...
              <div class="department-image">
                <img src="{{ asset('assets/img/health/cardiology-2.webp') }}" alt="Cardiology Department" class="img-fluid">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="department-item">
              ...
              <div class="department-image">
                <img src="{{ asset('assets/img/health/pediatrics-2.webp') }}" alt="Pediatrics Department" class="img-fluid">
                <div class="department-overlay">
                  <a href="#" class="department-link">
                    <i class="fas fa-arrow-right"></i>
                  </a>
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="500">
            <div class="department-item">
              ...
              <div class="department-image">
                <img src="{{ asset('assets/img/health/laboratory-3.webp') }}" alt="Laboratory Department" class="img-fluid">
                <div class="department-overlay">
                  <a href="#" class="department-link">
                    <i class="fas fa-arrow-right"></i>
                  </a>
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="600">
            <div class="department-item">
              ...
              <div class="department-image">
                <img src="{{ asset('assets/img/health/emergency-4.webp') }}" alt="Emergency Department" class="img-fluid">
                <div class="department-overlay">
                  <a href="#" class="department-link">
                    <i class="fas fa-arrow-right"></i>
                  </a>
